  ...
  async onload() {
    ...
    this.addCommand({
      ...
      editorCallback: async (editor, view) => {
        new import_obsidian.Notice("Generating tags...");
...
${content}
      ...
      await this.app.fileManager.processFrontMatter(file, (frontmatter) => {
        ...
        const uniqueTags = /* @__PURE__ */ new Set([...currentTags || [], ...tags]);
        frontmatter["tags"] = Array.from(uniqueTags);
      });
      new import_obsidian.Notice(`Added ${tags.length} tags!`);
    } catch (error) {
      console.error(error);
      new import_obsidian.Notice("Error occurred while generating tags.");
    }
  }
};
